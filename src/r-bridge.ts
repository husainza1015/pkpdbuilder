 ...
 * Execute raw R code
 */
export async function runRCode(code: string, timeout: number = 300000): Promise<RResult> {
 ...
 */
export async function testR(): Promise<boolean> {
 ...
 */
export async function installRPackage(packageName: string): Promise<RResult> {
  const code = `
