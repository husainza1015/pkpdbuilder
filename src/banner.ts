 ...
 */
function violetToCyanGradient(steps: number): Array<[number, number, number]> {
 ...
 */
function applyGradient(lines: string[]): string[] {
 ...
 */
export function printBanner(subtitle: string = "The Pharmacometrician's Co-Pilot"): void {
 ...
 */
export function printSimpleBanner(subtitle: string = "The Pharmacometrician's Co-Pilot"): void {
  console.log('');
 ...
 */
export function miniPrompt(): string {
