 ...
 */
export const runNcaTool = {
    name: 'run_nca',
    description: 'Perform non-compartmental analysis using PKNCA. Calculates AUC, Cmax, Tmax, half-life, clearance, volume.',
    input_schema: {
        type: 'object',
        properties: {
...
export async function runNca(args) {
    return {
        success: true,
