 ...
 */
export const fitModelTool = {
    name: 'fit_model',
    description: 'Fit a population PK model using nlmixr2. Specify model structure (1-cmt, 2-cmt, 3-cmt), route (iv, oral), and estimation method (focei, saem).',
    input_schema: {
        type: 'object',
        properties: {
...
export async function fitModel(args) {
    return {
        success: true,
...
export const fitFromLibraryTool = {
...
export async function fitFromLibrary(args) {
    return {
        success: true,
...
export async function compareModels(args) {
    return {
        ...
        comparison: args.model_names.map((m) => ({ model: m, ofv: 1234, aic: 1256 })),
    };
}
export const listModelLibraryTool = {
...
export async function listModelLibrary(args) {
    return {
        success: true,
        models: [
            'pk_1cmt_oral_1abs',
...
export async function getModelCode(args) {
    return {
        success: true,
